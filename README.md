...
I am currently solidifying my full-stack capabilities by mastering MongoDB to expand my database expertise. My goal is to become a highly proficient backend developer within the next six months. Following that, I plan to leverage my JavaScript knowledge to dive into mobile app development with React Native, aiming to bridge the gap between web and mobile.
